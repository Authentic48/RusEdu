				...
				<div class="blog-carousel-center owl-carousel owl-none">
						...
						<div class="testimonial-5">
							...
							<div class="testimonial-detail clearfix">
								<div class="testimonial-pic radius shadow">
									<img src="{{ asset('assets/images/testimonials/pic1.jpg')}}" width="100" height="100" alt="">
								</div>
					...
					<div class="item">
						<div class="testimonial-5">
							...
							<div class="testimonial-detail clearfix">
								<div class="testimonial-pic radius shadow">
									<img src="{{ asset('assets/images/testimonials/pic2.jpg')}}" width="100" height="100" alt="">
								</div>
								<strong class="testimonial-name">David Matin</strong> 
								<span class="testimonial-position">Student</span> 
							</div>
					...
					<div class="item">
						<div class="testimonial-5">
							...
							<div class="testimonial-detail clearfix">
								<div class="testimonial-pic radius shadow">
									<img src="{{asset('assets/images/testimonials/pic3.jpg')}}" width="100" height="100" alt="">
								</div>
								<strong class="testimonial-name">David Matin</strong> 
								<span class="testimonial-position">Student</span> 
							</div>
